...
<body class="bg-dark text-gray-100 font-sans">
    ...
    <!-- SECCIÓN INICIO -->
    <section id="inicio"
        class="reveal pt-32 pb-24 relative overflow-hidden opacity-40 translate-y-10 transition-all duration-700">
    ...
    <section class="relative overflow-hidden">
        <div class="absolute inset-0">
            <img src="{{ asset('images/fondo1.png') }}" alt="Fondo Barbería"
