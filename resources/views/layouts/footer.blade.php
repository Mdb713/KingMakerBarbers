...
<footer class="reveal bg-dark-gray border-t border-gold/10 py-12 opacity-0 translate-y-10 transition-all duration-700">
        ...
        <div class="grid md:grid-cols-3 gap-8 text-center md:text-left mb-8">
            ...
            <div>
                <div class="flex items-center gap-3 justify-center md:justify-start mb-4">
                    <div
                        class="w-12 h-12 bg-gradient-to-br from-gold to-yellow-600 rounded-lg flex items-center justify-center">
                ...
                <p class="text-gray-400 text-sm">Tu barbería masculina de confianza. Estilo, calidad y atención
                    personalizada.</p>
            </div>
            ...
            <div>
                ...
                <div class="flex gap-4 justify-center md:justify-start mb-4">
                    <a href="https://www.instagram.com" target="_blank"
                        class="w-10 h-10 bg-medium-gray rounded-lg flex items-center justify-center hover:bg-gold hover:text-dark transition-all text-lg">
